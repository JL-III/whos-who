      ...
      <div className="AllSite" style={{ backgroundColor: "darkGray" }}>
        <Route exact path="/">
          <Grid container spacing={2}>
            <Grid xs={7}>
              <Typography variant="h2">Whos Who?</Typography>
              <List>
                <ListItem>
                  <ListItemText
                    primary="Choose a genre"
                    secondary="Pick your favorite genre of music!"
                  />
                </ListItem>
                <ListItem>
                  <ListItemText
                    primary="Select the number of songs to sample from an artist"
                    secondary="More songs give you a better chance at guessing!"
                  />
                </ListItem>
                <ListItem>
                  <ListItemText
                    primary="Select the number of artists to choose"
                    secondary="The more artists there are the harder the game is!"
                  />
                </ListItem>
                <ListItem>
                  <ListItemText
                    primary="Click the play button!"
                    secondary="You have three tries to get as many correct as you can!"
                  />
                </ListItem>
              </List>
            </Grid>
